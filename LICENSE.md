...
This work is protected by copyright laws and international treaties. All rights are reserved in accordance with applicable regulations.

The reproduction, distribution, modification, or use of any part of this project (both graphic content and source code) for commercial or personal purposes is strictly prohibited without the explicit written authorization of the aforementioned rightful owners.
...
Quest'opera è protetta dalle leggi sul diritto d'autore e dai trattati internazionali. Tutti i diritti sono riservati in conformità alla normativa vigente.

È severamente vietata la riproduzione, la distribuzione, la modifica o l'utilizzo di qualsiasi parte di questo progetto (sia dei contenuti grafici che del codice sorgente) per scopi commerciali o personali senza l'esplicita autorizzazione scritta dei legittimi proprietari sopra indicati.

### 3. Contatti

Per richieste di utilizzo, informazioni o autorizzazioni, si prega di contattare: **unilocktcg@gmail.com** per il progetto, **vitalevalerio@hotmail.it** per il sito web.